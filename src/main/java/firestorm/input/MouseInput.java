package firestorm.input;

import java.awt.event.MouseAdapter;
import java.awt.event.MouseEvent;

/**
 * Created by slinkee on 10/11/2016.
 */
public class MouseInput extends MouseAdapter {
    ...
    public static void update() {
        ...
        // TODO: 10/11/2016 check for duration of no mouse movement and only set false after a set duration
        if (x == lastX || y == lastY)
            moving = false;
        lastX = x;
        lastY = y;
